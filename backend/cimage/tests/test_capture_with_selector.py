    # Captures screenshot of a valid URL with a specified selector
    def test_capture_screenshot_with_selector(self, mocker):
        # Mock the necessary dependencies
        mock_redis_client = mocker.Mock()
        mock_rq = mocker.Mock()
        mock_request = mocker.Mock(args={'url': 'https://example.com', 'selector': 'example-selector'})
        ...
        mock_rq.enqueue.assert_called_once_with(capture_screenshot_of_url, args=('https://example.com', 'example-selector'))
